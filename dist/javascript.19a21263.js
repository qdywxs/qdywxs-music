...
var svgPlaceholder = document.createElement("div"); //1️⃣创建一个 div；
  ...
  _createClass(Player, [{
    ...
    value: function start() {
      ...
      fetch("https://qdywxs.github.io/data-mock/qdywxs-music/music-list.json").then(function (res) {
        ...
        console.log(data);
        _this2.songList = data; //2️⃣然后将“数据”赋值给实例对象的 songList（箭头函数里的 this 指向它上一级的 this）；

        _this2.loadSong(); //3️⃣把获取到的“数据”先缓存起来；
